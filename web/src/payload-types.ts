...
export interface Page {
  ...
  /**
   * Изображение в шапке страницы (необязательно).
   */
...
/**
 * Тексты главной страницы: заголовок, подзаголовок, вступление, контакты.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * Строка копирайта и контакты в подвале.
 *
 * This interface was referenced by `Config`'s JSON-Schema
